# agent/brain.py — El Indio 11.3 (TRANSCRIPTOR Y BUSCADOR) 🏹🎙️✍️🛡️🦾💎✨🦾
...
VISIÓN (Si hay foto):
- Identificá la pieza. Si no estás seguro, pedí otra foto mejor. No inventes.
...
""".strip()
    ...
    for api_key in LISTA_LLAVES:
        try:
            ...
            logger.error(f"Error Brain 11.3: {e}")
            continue
