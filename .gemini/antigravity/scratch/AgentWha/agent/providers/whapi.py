    ...
    async def parsear_webhook(self, request: Request) -> list[MensajeEntrante]:
        try:
            ...
            for msg in body.get("messages", []):
                ...
                es_propio = msg.get("from_me", msg.get("fromMe", msg.get("out", False)))
                
                # 2. Corta-bucle de emergencia: Detectamos si el texto es nuestro mensaje de error
                texto_body = ""
                ...
                if es_propio:
                    logger.info(f"🚫 [BUCLE EVITADO] Ignorando mensaje SALIENTE (id: {msg.get('id')})")
